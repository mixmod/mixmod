...
DomProba::DomProba(string &sFilename) : xmlpp::Document() { set_internal_subset(sFilename, "", ""); }

DomProba::DomProba(xmlpp::Element *root) { _root = create_root_node_by_import(root); }
