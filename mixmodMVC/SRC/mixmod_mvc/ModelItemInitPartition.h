/***************************************************************************
                             SRC/GUI/MIXMOD_MVC/ModelItemInitPartition.h  description
...
***************************************************************************/
#ifndef __MODELITEMINITPARTITION_H__
#define __MODELITEMINITPARTITION_H__
...
template< >
class ModelItem<TreeInitPartition, string> : public AbstractModelItem {
public :
