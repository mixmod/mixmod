/***************************************************************************
                             SRC/GUI/MIXMOD_MVC/EventUserInsertWeight.cpp  description
...
#include "mixmod_mvc/EventUserInsertWeight.h"
...
EventUserInsertWeight::EventUserInsertWeight(string iFilename) {
	_filename = iFilename;
}


EventUserInsertWeight::~EventUserInsertWeight() {
}

void EventUserInsertWeight::process(TreeItem * treeItem) {
...
std::string EventUserInsertWeight::getDisplay() const {
	return string();
}

bool EventUserInsertWeight::launchNewEvent() const  {
	return true ;
}
}
}
