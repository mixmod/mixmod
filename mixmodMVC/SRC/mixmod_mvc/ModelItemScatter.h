/***************************************************************************
                             SRC/GUI/MIXMOD_MVC/ModelItemScatter.h  description
...
***************************************************************************/
#ifndef __MODELITEMINITSCATTER_H__
#define __MODELITEMINITSCATTER_H__
...
template< >
class ModelItem<TreeInitScatterChild, double> : public AbstractModelItem {
public :
