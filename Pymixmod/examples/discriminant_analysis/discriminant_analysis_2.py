...
def discriminant_analysis_2_example():
    ...
    # Gaussian + HD models
    models = [m for m in gm.ModelName if m.name.startswith('Gaussian')]
    iris_learn = mixmod.learn(data, known_labels, models=models)
...
if __name__ == '__main__':
    ...
    learn_step, prediction_step = discriminant_analysis_2_example()
    print(
        "-----------------------------------------------------------------------\n"
        "Learn step: \n"
        "-----------------------------------------------------------------------\n\n"
