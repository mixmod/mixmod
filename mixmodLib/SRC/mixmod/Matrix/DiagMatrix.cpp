...
DiagMatrix::DiagMatrix(DiagMatrix *A) : Matrix(A) { _store = copyTab(A->getStore(), _s_pbDimension); }
...
void DiagMatrix::compute_product_Lk_Wk(Matrix *Wk, double L) { THROW(OtherException, nonImplementedMethod); }
...
double *DiagMatrix::getDiagonalStore() { return (_store); }

double *DiagMatrix::getSymmetricStore() { THROW(OtherException, wrongMatrixType); }

double *DiagMatrix::getGeneralStore() { THROW(OtherException, wrongMatrixType); }

double DiagMatrix::getSphericalStore() { THROW(OtherException, wrongMatrixType); }
...
double DiagMatrix::trace_this_O_Sm1_O(GeneralMatrix *&O, DiagMatrix *&S) { THROW(OtherException, nonImplementedMethod); }

double DiagMatrix::compute_trace_W_C(Matrix *C) { THROW(OtherException, nonImplementedMethod); }

void DiagMatrix::computeShape_as__diag_Ot_this_O(DiagMatrix *&Shape, GeneralMatrix *&Ori, double diviseur)
{
	THROW(OtherException, nonImplementedMethod);
}
...
double *DiagMatrix::putGeneralValueInStore(double *store) { THROW(OtherException, wrongMatrixType); }

double *DiagMatrix::addGeneralValueInStore(double *store) { THROW(OtherException, wrongMatrixType); }

void DiagMatrix::computeSVD(DiagMatrix *&S, GeneralMatrix *&O) { THROW(OtherException, nonImplementedMethod); }
...
// add M to this
void DiagMatrix::operator+=(Matrix *M) { M->addDiagonalValueInStore(_store); }

void DiagMatrix::operator=(Matrix *M) { M->putDiagonalValueInStore(_store); }
...
double DiagMatrix::detDiag(Exception &errorType) { return determinant(errorType); }
