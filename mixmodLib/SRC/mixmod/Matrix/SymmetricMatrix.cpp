...
void SymmetricMatrix::equalToMatrixMultiplyByDouble(Matrix *D, double d) { THROW(OtherException, nonImplementedMethod); }

double *SymmetricMatrix::getDiagonalStore() { THROW(OtherException, wrongMatrixType); }

double *SymmetricMatrix::getSymmetricStore() { return (_store); }

double *SymmetricMatrix::getGeneralStore() { return (_store); }

double SymmetricMatrix::getSphericalStore() { THROW(OtherException, wrongMatrixType); }
...
double *SymmetricMatrix::putGeneralValueInStore(double *store) { THROW(OtherException, wrongMatrixType); }

double *SymmetricMatrix::addGeneralValueInStore(double *store) { THROW(OtherException, wrongMatrixType); }
...
void SymmetricMatrix::operator=(Matrix *M) { M->putSymmetricValueInStore(_store); }

// add M to this
void SymmetricMatrix::operator+=(Matrix *M) { M->addSymmetricValueInStore(_store); }

// compute Shape as diag(Ot . this . O ) / diviseur
void SymmetricMatrix::computeShape_as__diag_Ot_this_O(DiagMatrix *&Shape, GeneralMatrix *&Ori, double diviseur)
{
...
void SymmetricMatrix::compute_M_as__O_Sinverse_Ot_this(GeneralMatrix &M, GeneralMatrix *&O, DiagMatrix *&S)
{
