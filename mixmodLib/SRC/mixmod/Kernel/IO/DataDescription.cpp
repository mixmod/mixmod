...
//------------
DataDescription::DataDescription() : Description() { _data = NULL; }

//------------
// Constructor by initialization
//------------
DataDescription::DataDescription(int64_t nbSample, int64_t nbColumn, std::vector<ColumnDescription *> columnDescription,
...
// Constructor by copy
//------------
DataDescription::DataDescription(DataDescription &dataDescription) : Description(dataDescription) { *this = dataDescription; }
...
Data *DataDescription::createData() const
{
	...
	for (std::vector<ColumnDescription *>::const_iterator it = _columnDescription.begin(); it != _columnDescription.end();
	     it++) {
...
//---------------------
bool DataDescription::verifyData() const { return _data->verify(); }
