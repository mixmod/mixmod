...
GaussianGeneralParameter::GaussianGeneralParameter() { THROW(OtherException, wrongConstructorType); }
...
//-------------------------------------------------------------------------------------
GaussianGeneralParameter::GaussianGeneralParameter(int64_t iNbCluster, int64_t iPbDimension, ModelType *iModelType,
...
//-------------------------------------------------------------------------------------
GaussianGeneralParameter::GaussianGeneralParameter(int64_t iNbCluster, int64_t iPbDimension, ModelType *iModelType,
                                                   std::string &iFileName, int64_t iNbVariable_binary,
...
//-------------------------------------------------------------------------------------
GaussianGeneralParameter::GaussianGeneralParameter(int64_t iNbCluster, int64_t iPbDimension, ModelType *iModelType,
                                                   double *proportions, double **means, double ***variances)
    : GaussianEDDAParameter(iNbCluster, iPbDimension, iModelType)
{
	int64_t k;
	__storeDim = _pbDimension * (_pbDimension + 1) / 2;
