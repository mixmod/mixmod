...
// Default constructor
//--------------------
BinaryEParameter::BinaryEParameter() { THROW(OtherException, wrongConstructorType); }

//-------------------------------
// Constructor called by XEMModel
//-------------------------------
BinaryEParameter::BinaryEParameter(Model *iModel, ModelType *iModelType, int64_t *tabNbModality)
...
// copy Constructor
//-----------------
BinaryEParameter::BinaryEParameter(const BinaryEParameter *iParameter) : BinaryParameter(iParameter)
{
...
//---------------------------
void BinaryEParameter::inputScatter(std::ifstream &fi, int64_t k) { THROW(OtherException, internalMixmodError); }

// Read Scatter in input containers
//---------------------------
void BinaryEParameter::inputScatter(double ***scatters) { THROW(OtherException, internalMixmodError); }
