...
SEMAlgo::SEMAlgo() { _algoStopName = NBITERATION; }
...
// Constructor
//------------
SEMAlgo::SEMAlgo(AlgoStopName algoStopName, int64_t nbIteration) : Algo(algoStopName, defaultEpsilon, nbIteration) {}
...
// clone
//------
Algo *SEMAlgo::clone() { return (new SEMAlgo(*this)); }
