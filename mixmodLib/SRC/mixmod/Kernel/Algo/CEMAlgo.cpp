...
CEMAlgo::CEMAlgo(AlgoStopName algoStopName, double epsilon, int64_t nbIteration) : Algo(algoStopName, epsilon, nbIteration) {}
...
// clone
//------
Algo *CEMAlgo::clone() { return (new CEMAlgo(*this)); }
