...
extern int
    MASSICCC; // 0 = no output, 1 = output for massiccc purpose (progress file, entropy computation...), (11 = 1 for predict)
...
template <typename T> struct TabDeleter {
...
template <typename T> struct VectTabDeleter {
...
template <typename T> struct IfChangedDeleter {
