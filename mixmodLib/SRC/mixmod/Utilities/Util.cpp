...
{
	bool res = false;
	if ((modelName == Gaussian_p_L_I) || (modelName == Gaussian_p_Lk_I) || (modelName == Gaussian_pk_L_I) ||
...
{
	bool res = false;
	if ((modelName == Gaussian_p_L_B) || (modelName == Gaussian_p_Lk_B) || (modelName == Gaussian_p_L_Bk) ||
	    (modelName == Gaussian_p_Lk_Bk) || (modelName == Gaussian_pk_L_B) || (modelName == Gaussian_pk_Lk_B) ||
	    (modelName == Gaussian_pk_L_Bk) || (modelName == Gaussian_pk_Lk_Bk)) {
		res = true;
	}
	return res;
}
...
{
	bool res = false;
	if ((modelName == Gaussian_p_L_C) || (modelName == Gaussian_p_Lk_C) || (modelName == Gaussian_p_L_D_Ak_D) ||
	    (modelName == Gaussian_p_Lk_D_Ak_D) || (modelName == Gaussian_p_L_Dk_A_Dk) || (modelName == Gaussian_p_Lk_Dk_A_Dk) ||
	    (modelName == Gaussian_p_L_Ck) || (modelName == Gaussian_p_Lk_Ck) || (modelName == Gaussian_pk_L_C) ||
	    (modelName == Gaussian_pk_Lk_C) || (modelName == Gaussian_pk_L_D_Ak_D) || (modelName == Gaussian_pk_Lk_D_Ak_D) ||
	    (modelName == Gaussian_pk_L_Dk_A_Dk) || (modelName == Gaussian_pk_Lk_Dk_A_Dk) || (modelName == Gaussian_pk_L_Ck) ||
...
{
	bool res = false;
	if ((modelName == Gaussian_HD_p_AkjBkQkDk) || (modelName == Gaussian_HD_p_AkBkQkDk) ||
	    (modelName == Gaussian_HD_p_AkjBkQkD) || (modelName == Gaussian_HD_p_AjBkQkD) ||
	    (modelName == Gaussian_HD_p_AkjBQkD) || (modelName == Gaussian_HD_p_AjBQkD) || (modelName == Gaussian_HD_p_AkBkQkD) ||
	    (modelName == Gaussian_HD_p_AkBQkD) || (modelName == Gaussian_HD_pk_AkjBkQkDk) ||
	    (modelName == Gaussian_HD_pk_AkBkQkDk) || (modelName == Gaussian_HD_pk_AkjBkQkD) ||
	    (modelName == Gaussian_HD_pk_AjBkQkD) || (modelName == Gaussian_HD_pk_AkjBQkD) ||
	    (modelName == Gaussian_HD_pk_AjBQkD) || (modelName == Gaussian_HD_pk_AkBkQkD) ||
...
bool isFreeSubDimension(ModelName modelName)
{
	...
	if ((modelName == Gaussian_HD_p_AkjBkQkDk) || (modelName == Gaussian_HD_p_AkBkQkDk) ||
	    (modelName == Gaussian_HD_p_AkjBkQkD) || (modelName == Gaussian_HD_p_AjBkQkD) ||
	    (modelName == Gaussian_HD_p_AkBkQkD) || (modelName == Gaussian_HD_pk_AkjBkQkDk) ||
	    (modelName == Gaussian_HD_pk_AkBkQkDk) || (modelName == Gaussian_HD_pk_AkjBkQkD) ||
	    (modelName == Gaussian_HD_pk_AjBkQkD) || (modelName == Gaussian_HD_pk_AkBkQkD)) {
		res = true;
	}
	return res;
}
...
{
	bool res = false;
	if ((modelName == Binary_p_E) || (modelName == Binary_pk_E) || (modelName == Binary_p_Ej) || (modelName == Binary_pk_Ej) ||
	    (modelName == Binary_p_Ek) || (modelName == Binary_pk_Ek) || (modelName == Binary_p_Ekj) ||
	    (modelName == Binary_pk_Ekj) || (modelName == Binary_p_Ekjh) || (modelName == Binary_pk_Ekjh)) {
		res = true;
	}
	return res;
}
...
{
	if (modelname == Heterogeneous_p_E_L_B || modelname == Heterogeneous_p_E_L_Bk || modelname == Heterogeneous_p_E_Lk_B ||
	    modelname == Heterogeneous_p_E_Lk_Bk || modelname == Heterogeneous_p_Ej_L_B || modelname == Heterogeneous_p_Ej_L_Bk ||
	    modelname == Heterogeneous_p_Ej_Lk_B || modelname == Heterogeneous_p_Ej_Lk_Bk || modelname == Heterogeneous_p_Ek_L_B ||
	    modelname == Heterogeneous_p_Ek_L_Bk || modelname == Heterogeneous_p_Ek_Lk_B ||
	    modelname == Heterogeneous_p_Ek_Lk_Bk || modelname == Heterogeneous_p_Ekj_L_B ||
	    modelname == Heterogeneous_p_Ekj_L_Bk || modelname == Heterogeneous_p_Ekj_Lk_B ||
	    modelname == Heterogeneous_p_Ekj_Lk_Bk || modelname == Heterogeneous_p_Ekjh_L_B ||
	    modelname == Heterogeneous_p_Ekjh_L_Bk || modelname == Heterogeneous_p_Ekjh_Lk_B ||
	    modelname == Heterogeneous_p_Ekjh_Lk_Bk || modelname == Heterogeneous_pk_E_L_B ||
	    modelname == Heterogeneous_pk_E_L_Bk || modelname == Heterogeneous_pk_E_Lk_B ||
	    modelname == Heterogeneous_pk_E_Lk_Bk || modelname == Heterogeneous_pk_Ej_L_B ||
	    modelname == Heterogeneous_pk_Ej_L_Bk || modelname == Heterogeneous_pk_Ej_Lk_B ||
	    modelname == Heterogeneous_pk_Ej_Lk_Bk || modelname == Heterogeneous_pk_Ek_L_B ||
	    modelname == Heterogeneous_pk_Ek_L_Bk || modelname == Heterogeneous_pk_Ek_Lk_B ||
	    modelname == Heterogeneous_pk_Ek_Lk_Bk || modelname == Heterogeneous_pk_Ekj_L_B ||
	    modelname == Heterogeneous_pk_Ekj_L_Bk || modelname == Heterogeneous_pk_Ekj_Lk_B ||
	    modelname == Heterogeneous_pk_Ekj_Lk_Bk || modelname == Heterogeneous_pk_Ekjh_L_B ||
	    modelname == Heterogeneous_pk_Ekjh_L_Bk || modelname == Heterogeneous_pk_Ekjh_Lk_B ||
...
{
	if (isBinary(name))
		return QualitativeModel;

	if (isHeterogeneous(name))
...
{
	bool res = true;
	if ((modelName == Gaussian_p_L_I) || (modelName == Gaussian_p_Lk_I) || (modelName == Gaussian_p_L_B) ||
	    (modelName == Gaussian_p_Lk_B) || (modelName == Gaussian_p_L_Bk) || (modelName == Gaussian_p_Lk_Bk) ||
	    (modelName == Gaussian_p_L_C) || (modelName == Gaussian_p_Lk_C) || (modelName == Gaussian_p_L_D_Ak_D) ||
	    (modelName == Gaussian_p_Lk_D_Ak_D) || (modelName == Gaussian_p_L_Dk_A_Dk) || (modelName == Gaussian_p_Lk_Dk_A_Dk) ||
	    (modelName == Gaussian_p_L_Ck) || (modelName == Gaussian_p_Lk_Ck) || (modelName == Binary_p_E) ||
	    (modelName == Binary_p_Ej) || (modelName == Binary_p_Ek) || (modelName == Binary_p_Ekj) ||
	    (modelName == Binary_p_Ekjh) || (modelName == Gaussian_HD_p_AkjBkQkDk) || (modelName == Gaussian_HD_p_AkBkQkDk) ||
	    (modelName == Gaussian_HD_p_AkjBkQkD) || (modelName == Gaussian_HD_p_AjBkQkD) ||
	    (modelName == Gaussian_HD_p_AkjBQkD) || (modelName == Gaussian_HD_p_AjBQkD) || (modelName == Gaussian_HD_p_AkBkQkD) ||
	    (modelName == Gaussian_HD_p_AkBQkD) || modelName == Heterogeneous_p_E_L_B || modelName == Heterogeneous_p_E_L_Bk ||
	    modelName == Heterogeneous_p_E_Lk_B || modelName == Heterogeneous_p_E_Lk_Bk || modelName == Heterogeneous_p_Ej_L_B ||
	    modelName == Heterogeneous_p_Ej_L_Bk || modelName == Heterogeneous_p_Ej_Lk_B ||
	    modelName == Heterogeneous_p_Ej_Lk_Bk || modelName == Heterogeneous_p_Ek_L_B || modelName == Heterogeneous_p_Ek_L_Bk ||
	    modelName == Heterogeneous_p_Ek_Lk_B || modelName == Heterogeneous_p_Ek_Lk_Bk ||
	    modelName == Heterogeneous_p_Ekj_L_B || modelName == Heterogeneous_p_Ekj_L_Bk ||
	    modelName == Heterogeneous_p_Ekj_Lk_B || modelName == Heterogeneous_p_Ekj_Lk_Bk ||
	    modelName == Heterogeneous_p_Ekjh_L_B || modelName == Heterogeneous_p_Ekjh_L_Bk ||
	    modelName == Heterogeneous_p_Ekjh_Lk_B || modelName == Heterogeneous_p_Ekjh_Lk_Bk) {
		res = false;
	}
	return res;
}
...
void readTabFileName(std::ifstream &fi, int64_t nbNbCluster, std::string *tabFileName, std::string &keyWord)
{
	...
	if ((k != nbNbCluster - 1) || (tabFileName[nbNbCluster - 1].compare("") == 0) ||
	    (tabFileName[nbNbCluster - 1].compare(" ") == 0))
...
void quickSortWithOrder(double *tabRandom, int64_t *tabOrder, int64_t left, int64_t right)
{
	if (left < (right - SMALL_ENOUGH_TO_USE_SELECTION_SORT)) {
		...
		selectionSortWithOrder(tabRandom, tabOrder, left, right);
}
